...
\title{Einführung in C++ -- Übung 4 \\ Testatgruppe A (Isaak)}
...
\begin{document}
   ...
   \lstinputlisting[language=make,caption={CMakeLists.txt}]{src/CMakeLists.txt}
   \lstinputlisting[caption={objio.c}]{src/objio.c}
\end{document}
