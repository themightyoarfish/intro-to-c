...
public:
	 ...
	 */
	MainWindow(string filename, string mapName, string start, string end);
...
private:
    ...
    std::list<Vertex<float> > m_path;
    std::list<Vertex<float> > m_navpoints;
    
    /// Rendering object to display a path
    NavigationRoute*    m_navRoute;
